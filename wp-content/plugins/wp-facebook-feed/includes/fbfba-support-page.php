...
if( isset($_POST['submit']) ){
	...
	if($formok){
		...
		$emailbody = "<p>Facebook Feed Support From Plugin (Free Version).</p>
		...
		mail("arrowplugins@gmail.com","Facebook Feed Support From Plugin (Free Version)",$emailbody,$headers);
...
Your message has been sent successfully, Our support team will be in touch with you very soon.</p>
            <form method="post" action="">
                ...
                <input placeholder="http://www.website.com" type="url" id="telephone" name="telephone" value="<?php echo ($sr && !$cf['form_ok']) ? $cf['posted_form_data']['telephone'] : '' ?>" required/>
